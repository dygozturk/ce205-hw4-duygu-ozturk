...
namespace ce205_hw4_duygu_ozturk
{
    public partial class Form1 : Form
    {
        ...
        private void SearchKnuth_Click(object sender, EventArgs e)
        {
            ...
            private void KnuthtextBox_TextChanged(object sender, EventArgs e)
            {
        ...
        private void InsertTrie_Click(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.Text = richTextBox2.Text + keys[i] + Environment.NewLine;
        ...
        private void SearchTrie_Click(object sender, EventArgs e)
        {
            ...
            string[] words = richTextBox2.Text.Split(new[] { ' ', '\n', '\r' }, StringSplitOptions.RemoveEmptyEntries);
        ...
        private void randomNW_Click(object sender, EventArgs e)
        {
            int length = 2000;
        ...
        private void randomNW1_Click(object sender, EventArgs e)
        {
            int length = 2000;
        ...
        private void randomSW_Click(object sender, EventArgs e)
        {
            int length = 2000;
        ...
        private void randomT_Click(object sender, EventArgs e)
        {
